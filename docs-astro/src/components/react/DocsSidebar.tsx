 ...
 *
 * Current-page detection is passed in from the Astro layout via
 * Astro.url.pathname, so the correct active item is server-rendered
 * and the component can stay non-hydrated.
 */
